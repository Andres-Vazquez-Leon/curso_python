"""frases_celebres.py : Archivo que contiene las funciones basicas para 
manipular las frases celebres de una pelicula"""
import csv
import json
import Levenshtein
class Frase:
    ...
    def __str__(self):
        """ Devuelve la frase en ofrmato string"""
...
def carga_archivo_csv(nombre_archivo):
    """ Carga un archivo csv y devuelve una lista de frases"""
    frases = []
    try:
